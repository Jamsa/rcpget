...
public interface IImageKeys {
	public static final String RCP_GET = "icons/rcpget.gif";
	public static final String NEW_TASK = "icons/task-add.gif";
	public static final String DELETE_TASK = "icons/task-delete.gif";
	public static final String MODIFY_TASK = "icons/task-edit.gif";
	public static final String RUN_TASK = "icons/task-run.gif";
